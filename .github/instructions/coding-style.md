...
### Data structures (Article point 1)
...
### Minimize allocations (Article point 2)
...
### Memory usage, `Span<T>`, `Memory<T>` (Article point 3)
...
### Profile before micro-optimizing (Article point 5)
...
### Async where it helps (Article point 6)
...
### Avoid boxing/unboxing (Article point 12)
...
### Prefer immutable semantics for shared state (Article point 13)
