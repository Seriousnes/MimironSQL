...
public sealed class DbContextGenerator : IIncrementalGenerator
{
    ...
    private static string RenderContext(ImmutableArray<EntitySpec> entities)
    {
        ...
        sb.AppendLine("using MimironSQL.Formats;");
        sb.AppendLine("using MimironSQL.Providers;");
        sb.AppendLine();
        sb.AppendLine("namespace MimironSQL;");
        sb.AppendLine();
        sb.AppendLine("public partial class WoWDb2Context(IDbdProvider dbdProvider, IDb2StreamProvider db2StreamProvider, IDb2Format format) : Db2Context(dbdProvider, db2StreamProvider, format)");
        sb.AppendLine("{");
